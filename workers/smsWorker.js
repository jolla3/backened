...
const SMS_WORKER_CONFIG = {
  ...
  // Health/balance poll — default 5 minutes (was pollInterval*6 ≈ 30s and spammed snapshots)
  balanceCheckIntervalMs: parseInt(process.env.SMS_BALANCE_CHECK_INTERVAL_MS || '300000', 10),
};
